...
u(eg,I);eg.prototype.getKey=function(){return Hc(this,1)};
...
u(jg,I);jg.prototype.getPlayerType=function(){return Hc(this,36)};
...
u(ug,I);ug.prototype.getKey=function(){return Pc(this,1)};
...
u(Jg,I);Jg.prototype.setVideoId=function(a){return Jc(this,1,Kg,a)};
...
Oc(e,15,eg,g)}H(b,5,e)}fi(a,c);gi(a,c);hi(c);ii(a,c);ji(c);N("DELEGATED_SESSION_ID")&&!P("pageid_as_header_web")&&(a=new og,G(a,3,N("DELEGATED_SESSION_ID")));a=t(Object.entries(yh(N("DEVICE",""))));for(d=a.next();!d.done;d=a.next())e=t(d.value),d=e.next().value,e=e.next().value,"cbrand"===d?G(c,12,e):"cmodel"===d?G(c,13,e):"cbr"===d?G(c,87,e):"cbrver"===d?G(c,88,e):"cos"===d?G(c,18,e):"cosver"===d?G(c,19,e):"cplatform"===d&&G(c,42,e);H(b,1,c);return b}
function fi(a,b,c){a=a.Aa;if("WEB"===a||"MWEB"===a||1===a||2===a)if(b){c=Lc(b,hg,96)||new hg;var d=Xh();null!==d&&G(c,3,d);H(b,96,c)}else c&&(c.client.mainAppWebInfo=null!=(d=c.client.mainAppWebInfo)?d:{},c.client.mainAppWebInfo.webDisplayMode=Wh())}
function gi(a,b,c){a=a.Aa;if(("WEB_REMIX"===a||76===a)&&!P("music_web_display_mode_killswitch"))if(b){var d;c=null!=(d=Lc(b,ig,70))?d:new ig;d=Xh();null!==d&&G(c,10,d);H(b,70,c)}else if(c){var e;c.client.Sa=null!=(e=c.client.Sa)?e:{};c.client.Sa.webDisplayMode=Wh()}}
...
function ii(a,b,c){if(a.appInstallData)if(b){var d;c=null!=(d=Lc(b,gg,62))?d:new gg;G(c,6,a.appInstallData);H(b,62,c)}else c&&(c.client.configInfo=c.client.configInfo||{},c.client.configInfo.appInstallData=a.appInstallData)}
...
function qm(a,b){var c="";if(a.da)c="visitorOnlyApprovedKey";else if(a.P){if(void 0===b?0:b){b=a.P.token;c=a.P;var d=new Jg;c.videoId?d.setVideoId(c.videoId):c.playlistId&&Jc(d,2,Kg,c.playlistId);om[b]=d}else b=a.P,c={},b.videoId?c.videoId=b.videoId:b.playlistId&&(c.playlistId=b.playlistId),nm[a.P.token]=c;c=a.P.token}return c}
...
g||b()},d));
km=!1}}
function ym(a,b,c,d){var e=gm;c=void 0===c?{}:c;var f=Math.round(Q()),g=a.size;a=t(a);for(var h=a.next();!h.done;h=a.next()){var k=t(h.value);h=k.next().value;var l=k=k.next().value;k=new Lg;var n=ki(e.config_||di());H(k,1,n);l=Dm(l);for(n=0;n<l.length;n++)Oc(k,3,Gg,l[n]);(l=om[h])&&Em(k,h,l);delete om[h];h="visitorOnlyApprovedKey"===h;Fm(k,f,h);Bm(c);k=Zc(k);h=Cm(c,h,function(){g--;g||b()},function(){g--;
g||b()},d);
...
function Em(a,b,c){if(Hc(c,1===Kc(c,Kg)?1:-1))var d=1;else if(c.getPlaylistId())d=2;else return;H(a,4,c);a=Lc(a,qg,1)||new qg;c=Lc(a,og,3)||new og;var e=new ng;e.setToken(b);G(e,1,d);Oc(c,12,ng,e);H(a,3,c)}
...
new yg;G(lb,1,R.message);G(lb,3,R.name);G(lb,6,R.sampleWeight);"ERROR"===rc?G(lb,2,2):"WARNING"===rc?G(lb,2,1):G(lb,2,0);var Bf=new wg;G(Bf,1,!0);Nc(Bf,3,xg,Rb);var mb=new sg;G(mb,3,window.location.href);for(var Nj=N("FEXP_EXPERIMENTS",[]),Cf=0;Cf<Nj.length;Cf++){var Oj=mb,En=Nj[Cf];Ec(Oj);Ic(Oj,5).push(En)}var Df=bh();if(!ch()&&Df)for(var Pj=t(Object.keys(Df)),nb=Pj.next();!nb.done;nb=Pj.next()){var Qj=nb.value,Ef=new ug;G(Ef,1,Qj);Ef.setValue(String(Df[Qj]));Oc(mb,4,ug,Ef)}var Ff=R.params;if(Ff){var Rj=
t(Object.keys(Ff));for(nb=Rj.next();!nb.done;nb=Rj.next()){var Sj=nb.value,Gf=new ug;G(Gf,1,"client."+Sj);Gf.setValue(String(Ff[Sj]));Oc(mb,4,ug,Gf)}}var Tj=N("SERVER_NAME",void 0),Uj=N("SERVER_VERSION",void 0);if(Tj&&Uj){var Hf=new ug;G(Hf,1,"server.name");Hf.setValue(Tj);Oc(mb,4,ug,Hf);var If=new ug;G(If,1,"server.version");If.setValue(Uj);Oc(mb,4,ug,If)}var vd=new zg;H(vd,1,mb);H(vd,2,Bf);H(vd,3,lb);Af=vd}var Vj=Af;if(!Vj)break a;var Wj=new Gg;Nc(Wj,163,Hg,Vj);Xm(Wj)}else{if(dn())zf=void 0;else{var sc=
